...
export default Taste_Main;
  ...
  //     .then((data) => data.json())
  //     .then((info) => {
  //       setAppState({ loading: false, info: info });
  //     });
  // }, [setAppState]);


//   // console.log(appState.info);
...
//     <ScreenContainer>
//       <div>
//         <InfoLoading isLoading={appState.loading} info={appState.info} />
//       </div>
//       {/* <GradientContainer>
//         <HeaderContainer>
...
//             <MainNamesContainer>
//               <NameText>{appState.info.fname}</NameText>
